...
\begin{itemize}
  \setlength{\itemsep}{1pt}
  \setlength{\parskip}{0pt}
  \item 영남이공대학교 창업동아리 경진대회 (스마트 헬멧) — 최우수상 (14개팀 중 2등)
\end{itemize}
...
\begin{itemize}
  \setlength{\itemsep}{1pt}
  \setlength{\parskip}{0pt}
  \item 영남이공대학교 창업동아리 경진대회 (키오스크 교육) — 장려상
  \item 맨드로바 메이커톤 2022 — 아이디어상
\end{itemize}
...
\begin{itemize}
  \setlength{\itemsep}{1pt}
  \setlength{\parskip}{0pt}
  \item N.A.P (Networks Application Programming) — 전공 동아리 & 창업 동아리 (2021.03 -- 2022.12)
  \item 미래산업 수요특화 VR 교육 — 45시간 VR 부트캠프 수료 (언리얼 엔진 4 활용)
\end{itemize}
...
\begin{itemize}
  ...
  \setlength{\parskip}{0pt}
  \item N.A.P (Networks Application Programming) — 전공 동아리 & 창업 동아리 (2021.03 -- 2022.12)
  \item 스마트시티 프로젝트 — 제대로리빙랩 도시문제발굴단 (장애인 콜택시 문제 해결방안 제시)
\end{itemize}
