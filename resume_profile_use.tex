...
\begin{minipage}[t]{0.72\textwidth}
  ...
  나이: 25세(2000.08.10) | 성별: 남 | 경력: 1년 이상 | AI 소프트웨어 개발자\\
...
\begin{tabularx}{\textwidth}{|X|m{2.5cm}|m{2.5cm}|}
  \hline
  \headercell{시험명} & \headercell{등급} & \headercell{취득일} \\
  \hline
  JLPT (일본어능력시험) & N3 & 2023.01.12 \\
  \hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|X|m{4.5cm}|}
  ...
  \hline
  MOS (Microsoft Office Specialist) - Excel & Microsoft \\
  \hline
  빅데이터전문가 1급 & 한국직업능력검정협회 \\
  \hline
\end{tabularx}
